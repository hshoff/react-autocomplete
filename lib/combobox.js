...
module.exports = React.createClass({displayName: 'exports',
  ...
  */
  ...
  selectOption: function(child, options) {
    options = options || {};
    console.log(child, options, getLabel(child), child.props)
    this.setState({
  ...
  render: function() {
    return (
      React.DOM.div({className: this.getClassName()},
        React.DOM.div({className: 'input-addon'},
          React.DOM.input({
            ref: "input",
            type: "text",
            className: "rf-combobox-input input-stem",
          ...
          React.DOM.span({
            'aria-hidden': "true",
            className: "rf-combobox-button input-suffix btn btn-primary icon icon-search",
        ...
        React.DOM.div({
          ...
          ref: "list",
          className: "rf-combobox-list panel",
...
function getLabel(component) {
  ...
  if (_.isArray(component)) {
    component = _.reduce(component, function(memo, c) {
      return memo + c.props.children;
    }, '');
  }
